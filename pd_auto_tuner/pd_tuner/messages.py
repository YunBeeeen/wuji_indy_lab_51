...
class CommandKind(str, Enum):
    ...
    PAUSE_AUTOTUNE = "pause_autotune"
    RESUME_AUTOTUNE = "resume_autotune"
    CANCEL_AUTOTUNE = "cancel_autotune"
...
class EventKind(str, Enum):
    ...
    AUTOTUNE_STARTED = "autotune_started"
    AUTOTUNE_CANDIDATE_STARTED = "autotune_candidate_started"
    AUTOTUNE_PROGRESS = "autotune_progress"
    AUTOTUNE_CANDIDATE_RESULT = "autotune_candidate_result"
    AUTOTUNE_COMPLETE = "autotune_complete"
