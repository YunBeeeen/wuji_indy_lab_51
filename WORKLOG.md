...
- Wuji hand actuator gain이 전체 finger 공통으로 `stiffness=8.0`, `damping=0.5`, `friction=0.02` 상태임을 확인함.
...
- 1순위: 손가락 actuator (`stiffness=8.0`, `damping=0.5`)가 물러서 `0.08 kg`을 못 쥘 수 있음.
